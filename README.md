...
- **Daily Goals**: Monitor your "BrainRot" level with daily aggregate statistics.
...
5. **Important**: You must manually enable the **BrainRot Accessibility Service** in `Settings > Accessibility` for the app to function.
